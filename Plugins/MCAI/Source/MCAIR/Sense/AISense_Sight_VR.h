...
#include "AISense_Sight_VR_Interface.h"

#include "AISense_Sight_VR.generated.h"
...
class MCAIR_API UAISenseConfig_Sight_VR : public UAISenseConfig
{
...
USTRUCT()
struct MCAIR_API FAISightEventVR
{
...
struct FAISightTargetVR
{
	...
	FORCEINLINE FVector GetLocationSimple() const
	{
		...
		return Target.IsValid() ? (Target->GetClass()->ImplementsInterface(UAISense_Sight_VR_Interface::StaticClass()) ? IAISense_Sight_VR_Interface::Execute_GetVRLocation_Inline(Target.Get()) : Target->GetActorLocation()) : FVector::ZeroVector;
	}
...
class MCAIR_API UAISense_Sight_VR : public UAISense
{
	GENERATED_UCLASS_BODY()
